...
const ProductSubCategory = ({categoryName}) => {
  ...
  const { subcategory:childCategory } = useParams();
...
const updateSearchParams = (newParams) => {
 ...
 const handleFilterChange = (category, value) => {
  ...
  query.set('brand', brands.join(','));
    ...
    const baseURL = routes.getProductsBySubCategorySlug;
...
{showFilters && <div className={styles.overlay} />}
        <div className={styles.main_content}>
          ...
          <div className={styles.filter_section}>
              <h3 className={styles.filter_title}>Brands</h3>
 ...
 <span 
  ...
  onClick={(e) => e.stopPropagation()}> {subCategory}</span>
</span>
          ...
          <div className={styles.products_section}>
            <div className={styles.filter_bar}>
              <div className={styles.breadcrumb}>
                ...
                <span className={styles.separator}>/</span>
                <span>{renderCategoryName(subCategory)}</span>
